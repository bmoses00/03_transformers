...
struct matrix * make_rotX(double theta) {
  ...
  transform->m[1][1] = cos(theta * M_PI / 180);
  transform->m[2][1] = sin(theta * M_PI / 180);
  transform->m[1][2] = -sin(theta * M_PI / 180);
  transform->m[2][2] = cos(theta * M_PI / 180);
...
struct matrix * make_rotY(double theta) {
  ...
  transform->m[0][0] = cos(theta * M_PI / 180);
  transform->m[0][2] = sin(theta * M_PI / 180);
  transform->m[2][0] = -sin(theta * M_PI / 180);
  transform->m[2][2] = cos(theta * M_PI / 180);
...
struct matrix * make_rotZ(double theta) {
  ...
  transform->m[0][0] = cos(theta * M_PI / 180);
  transform->m[0][1] = -sin(theta * M_PI / 180);
  transform->m[1][0] = sin(theta * M_PI / 180);
  transform->m[1][1] = cos(theta * M_PI / 180);
  return transform;
}
